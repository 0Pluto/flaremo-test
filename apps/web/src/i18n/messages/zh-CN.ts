...
const messages = {
  ...
  "calendar.filterNotes": "记录",
  "calendar.filterTasks": "待办",
  "calendar.noNotes": "这一天没有写记录。",
  "calendar.rescheduleToday": "今天",
  "calendar.rescheduleTomorrow": "明天",
  "calendar.rescheduleNextWeek": "下周",
  "calendar.reschedulePickDate": "选择日期",
  "calendar.monthStats": "本月 {notes} 条记录 · {tasks} 项待办",
  "calendar.createNote": "写记录",
  "calendar.quickNotePlaceholder": "记录这一天的新想法…（Cmd+Enter 发送）",
  "calendar.noteCreated": "记录已发布",
  ...
  "share.imageStats": "{count} 条笔记 · {days} 天",
