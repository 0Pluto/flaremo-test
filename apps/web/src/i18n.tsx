...
const messages = {
  "zh-CN": {
    ...
    "calendar.title": "日历",
    "calendar.today": "回到今天",
    "calendar.todayMini": "回到今天",
    "calendar.todayTitle": "今天",
    "calendar.prevMonth": "上一月",
    "calendar.nextMonth": "下一月",
    "calendar.day": "打开 {date}",
    "calendar.dayTasks": "{count} 个日程",
    "calendar.dueEmpty": "这一天没有排下的日程。",
    "calendar.notesCount": "{count} 条笔记",
    "calendar.monthNotes": "本月共写了 {count} 条笔记。",
    "calendar.viewDayNotes": "查看这一天的笔记 →",
    "calendar.quickAdd": "新建日程",
    "calendar.quickAddPlaceholder": "这一天要做什么？",
    "calendar.defaultProject": "日程",
    "calendar.reschedule": "改期",
    "calendar.toastCreated": "已加入日程",
    "calendar.toastRescheduled": "日程已改期",
    "calendar.dayNoteTasks": "这天有 {count} 条笔记带着未勾选的待办",
    "calendar.dragHint": "拖到其他日期即可改期",
    "calendar.viewLabel": "日历视图",
    "calendar.viewMonth": "月历",
    "calendar.viewAgenda": "议程",
    "calendar.viewAgendaJump": "查看这天的日程",
    "calendar.agendaTitle": "按日期排列的日程",
    "calendar.agendaEmpty": "还没有排下的日程，回月历添加一个。",
    ...
    "calendar.deleteTask": "删除日程",
    "calendar.deleteTaskConfirm": "确定删除日程「{title}」？此操作不可撤销。",
    ...
    "share.subtitle": "谁可以查看这条记录？",
    "share.desc.private": "只有自己可以查看，默认选项。",
    "share.desc.protected": "团队成员可以查看。",
    "share.desc.public": "通过公开链接，任何人都可以查看。",
    "share.confirm": "保存",
    "memo.restore": "恢复",
    "memo.pin": "置顶",
  ...
  "en-US": {
    ...
    "calendar.todayMini": "Back to today",
    "calendar.todayTitle": "Today",
    "calendar.prevMonth": "Previous month",
    "calendar.nextMonth": "Next month",
    "calendar.day": "Open {date}",
    "calendar.dayTasks": "{count} scheduled",
    "calendar.dueEmpty": "Nothing scheduled for this day.",
    "calendar.notesCount": "{count} notes",
    "calendar.monthNotes": "{count} notes written this month.",
    "calendar.viewDayNotes": "View notes for this day →",
    "calendar.quickAdd": "New schedule",
    "calendar.quickAddPlaceholder": "What happens on this day?",
    "calendar.defaultProject": "Schedule",
    "calendar.reschedule": "Reschedule",
    "calendar.toastCreated": "Added to schedule",
    "calendar.toastRescheduled": "Schedule rescheduled",
    "calendar.dayNoteTasks": "{count} note(s) here still have unchecked to-dos",
    "calendar.dragHint": "Drag onto another date to reschedule",
    "calendar.viewLabel": "Calendar view",
    "calendar.viewMonth": "Month",
    "calendar.viewAgenda": "Agenda",
    "calendar.viewAgendaJump": "View this day",
    "calendar.agendaTitle": "Schedule by day",
    "calendar.agendaEmpty":
      "Nothing scheduled yet. Add one from the month view.",
    ...
    "calendar.dayOverdue": "{count} overdue",
    "calendar.deleteTask": "Delete schedule item",
    "calendar.deleteTaskConfirm":
      'Delete schedule item "{title}"? This cannot be undone.',
    "calendar.toastDeleted": "Schedule item deleted",
    "calendar.toastRescheduledPast": "Rescheduled to {date} (in the past).",
    "calendar.actionFailed": "Action failed, please retry.",
    ...
    "shortcuts.composer": "Focus the new memo composer",
    ...
    "share.subtitle": "Who can view this memo?",
    "share.desc.private": "Only you can view it. This is the default.",
    "share.desc.protected": "Everyone in your team can view it.",
    "share.desc.public": "Anyone can view it through the public link.",
    "share.confirm": "Save",
    ...
    "admin.role.admin": "Team administrator",
    ...
    "admin.makeAdmin": "Make team administrator",
    "admin.makeMember": "Make regular member",
