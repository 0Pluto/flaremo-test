 ...
 *
 * The wire-level primitives (reader/writer, transport framing, base64, enum
 * tables, and value-coercion helpers) live in memos-compat/proto-wire.ts and
 * were moved there verbatim.
 */
