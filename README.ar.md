...
- **عقل ثانٍ أصيل الذكاء الاصطناعي (AI-Native)**: يأتي مركز «Agent Memory» مع واجهة سطر أوامر (CLI) ومهارة تعمل عبر الوكلاء، تتيحان لوكلاء الذكاء الاصطناعي (Claude، Cursor، Codex، ChatGPT، ZCode) قراءة تفضيلاتك طويلة المدى وسياقات ذاكرتك وتحديثها؛ كما تبقى نقاط نهاية MCP متاحة.
...
### 2. ذاكرة الذكاء الاصطناعي طويلة المدى (CLI + Skills)
- **Agent Memory**: يتضمن أداة سطر الأوامر `flaremo` والمهارة `flaremo-memory` — يسجّل وكلاء الذكاء الاصطناعي الذاكرة طويلة المدى عبر الجلسات ويحدّثونها (التفضيلات، قرارات المشاريع، القيود، الدروس المستفادة) على أساس REST مشترك.
- **الإنسان في الحلقة**: راجع الذكريات التي سجّلها الذكاء الاصطناعي وتحقق منها وثبّتها أو صححها عبر `/memory`.
- **نظام بيئي مفتوح**: المسار الموصى به هو CLI + Skills، مع بقاء نقاطي النهاية `/memory/mcp` (Streamable HTTP MCP) و`/mcp` متاحتين لعملاء MCP الحاليين.
